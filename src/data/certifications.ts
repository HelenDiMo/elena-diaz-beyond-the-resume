...
export const certifications: Certification[] = [
  ...
  /* SECCIÓN: AI / Inteligencia Artificial */
...

  {
    ...
    date: "2026",
    description:
      "Formación en entornos Agile y Scrum, con enfoque en colaboración, testing, integración continua, automatización y buenas prácticas de desarrollo.",
  ...
  },
  {
    ...
    issuer: "Consorcio Fernando de los Ríos",
    category: "Gestión y Operaciones",
    date: "2020",
    description:
      "Formación para manjeo de Adobe Spark y Canva, con la finalidad de realizar contenido digital para RRSS y Webs.",
    credentialUrl:
